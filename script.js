...
function sendemail() {
  window.open(
    `mailto:contact@styxo.codes?subject=${document.querySelector(".formBx form input").value
...
function email() {
  var email = `mailto:contact@styxo.codes?subject=${document.querySelector(".formBx form input").value
    }&body=${document.querySelector(".formBx form textarea").value}`;
  return email;
}
